function handleItemClick(item, callback) {
    ...
    if(item.innerHTML === "Chainsaw man"){
      ...
      showimg.src = "pictures/chaincover.jpg";
      ...
      lbgen.innerHTML = "GENRE: Action, Drama, Fantasy, Horror"
      ...
      lbgen.innerHTML = "GENRE: Action, Drama, Romance"
      ...
      lbgen.innerHTML = "GENRE: Action, Drama, Fantasy, Martial Arts,Magic"
      ...
      lbgen.innerHTML = "GENRE: Action, Comedy, Family, Supernatural"
      watchlink.href = "Videoplayers/extra/extras.html";
    }
      ...
      lbrate.innerHTML = "Rating: 8.3/10";
      lbgen.innerHTML = "GENRE: Action, Fantasy, Tragedy,Drama";
      watchlink.href = "Videoplayers/extra/extras.html";
    }
    else if(item.innerHTML === "Demon Slayer"){
      previmg.src ="pictures/KNYprev.png";
      showimg.src = "pictures/slayer.jpg";
      ...
      lbgen.innerHTML = "GENRE:Action, Fantasy, Demons"
      watchlink.href = "Videoplayers/extra/extras.html";
    }
      ...
      lbrate.innerHTML = "Rating: 8.3/10";
      lbgen.innerHTML = "GENRE: Fantasy, Science Fiction, Drama";
      watchlink.href = "Videoplayers/extra/extras.html";
    }
      ...
      lbgen.innerHTML = "GENRE: Action, School, Supernatural, Shounen"
      watchlink.href = "Videoplayers/extra/extras.html";
    }
      ...
      lbgen.innerHTML = "GENRE: Action, Shounen, Martial Arts, Ninja"
